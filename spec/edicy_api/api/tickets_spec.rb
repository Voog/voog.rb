...
describe Edicy::API::Tickets do
  ...
  describe '#delete_ticket' do
    ...
    it 'calls delete method on ticket' do
      ...
      assert_requested :delete, 'http://edicy.test/admin/api/forms/1/tickets/2'
    end
  end
  ...
  describe '#delete_spam_tickets' do
    ...
    it 'calls delete_spam method on ticket' do
      ...
      assert_requested :delete, 'http://edicy.test/admin/api/forms/1/tickets/delete_spam'
    end
  end
end
