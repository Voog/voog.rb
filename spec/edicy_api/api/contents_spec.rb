...
describe Edicy::API::Contents do
  ...
  describe '#contents' do
    ...
    it 'returns a list of contents' do
      expect(client.contents(Edicy::API::Contents::ParentKind::Page, 1).length).to eql(2)
    end
  end
  ...
  describe '#delete_content' do
    ...
    it 'calls delete method on content' do
      client.delete_content(Edicy::API::Contents::ParentKind::Page, 1, 2)
      assert_requested :delete, 'http://edicy.test/admin/api/pages/1/contents/2'
    end
  end
  ...
  describe '#move_content' do
    ...
    it 'responds with new name' do
      expect(client.move_content(Edicy::API::Contents::ParentKind::Page, 1, 2, name: 'body').name).to eq('body')
    end
  end
end
